...
import br.com.devmedia.model.CalculadorDeTempoDeCaminhada;
...
public class CaminhadaController {
    ...
    public String exibeResultado(@RequestParam(value = "distanciaEmKm", required = true)
      final Float distanciaEmKm, final Model model) {
